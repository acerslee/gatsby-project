...
const PersonalSection = ({ node }) => {
  return (
    <AboutContainer id="about" aria-label="introduction and tools I know">
      <Biography>
        <StaticImage
        ...
        />
        <AboutMe>
          <AboutParagraph>{node.node.about.about}</AboutParagraph>
          <AboutCaption>Experienced with the following:</AboutCaption>
